...
Begin VB.Form frmEntradaCadastroItem 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Entrada Cadastro"
   ClientHeight    =   2730
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11115
   ...
   Begin VB.Frame frIncliurItem 
      ...
      Begin VB.Image cmdConsulInsumos 
         Height          =   360
         Left            =   1440
         Picture         =   "frmEntradaCadastroItem.frx":0000
         Stretch         =   -1  'True
   ...
   Begin Vendas.VistaButton cmdSair 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEntradaCadastroItem.frx":030A
      Pictures        =   1
      UseMaskColor    =   -1  'True
      MaskColor       =   65280
      Enabled         =   -1  'True
   ...
   Begin Vendas.VistaButton cmdGravarI 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEntradaCadastroItem.frx":0414
      Pictures        =   1
      UseMaskColor    =   -1  'True
      MaskColor       =   65280
      Enabled         =   -1  'True
   ...
   Begin VB.Image Image1 
      Height          =   2640
      Left            =   0
      Picture         =   "frmEntradaCadastroItem.frx":0966
      Stretch         =   -1  'True
      Top             =   0
      Width           =   11115
   End
End
Attribute VB_Name = "frmEntradaCadastroItem"
...
Private Sub cmdSair_Click()
    Unload Me
    Set frmEntradaCadastroItem = Nothing
End Sub
...
Private Sub cmdGravarI_Click()
    ...
    If txtPrecoCustoI.text <> "" Then
        campo = campo & ", precocusto"
        Scampo = Scampo & ", '" & FormatValor(txtPrecoCustoI.text, 1) & "'"
    End If

    ' Incluir valor na tabela EntradaItens
    sqlIncluir "EntradaItens", campo, Scampo, Me, "S"

    ' Alteara estoque na tabela Estoque
    Sqlconsulta = "id_estoque = '" & txtid_estoque.text & "'"
    campo = "preco_compra = '" & FormatValor(txtPrecoCustoI.text, 1) & "'"
    campo = campo & ", data_compra = '" & Format(txtdataEntrada.text, "YYYYMMDD") & "'"
    campo = campo & ", quant_compra = '" & FormatValor(txtQuantidadeI.text, 1) & "'"
    campo = campo & ", id_fornecedor = '" & txtid_fornecedor.text & "'"
...
Private Sub IncluirSaldo()
    ...
    If Tabela.RecordCount > 0 Then
        ...
        mQuantidade = txtQuantidadeI.text
