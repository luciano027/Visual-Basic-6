...
Begin VB.Form frmEstoqueRelatorios 
   ...
   Begin Vendas.VistaButton cmdSair 
      ...
      EndProperty
      Picture         =   "frmEstoqueRelatorios.frx":0000
      Pictures        =   1
      UseMaskColor    =   -1  'True
      MaskColor       =   65280
      Enabled         =   -1  'True
   ...
   Begin Vendas.VistaButton cmdRelatorios 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmEstoqueRelatorios.frx":010A
      Pictures        =   1
      UseMaskColor    =   -1  'True
      MaskColor       =   65280
      Enabled         =   -1  'True
   ...
   Begin VB.Image Image1 
      Height          =   3840
      Left            =   0
      Picture         =   "frmEstoqueRelatorios.frx":021C
      Stretch         =   -1  'True
      Top             =   -120
      Width           =   5115
   End
End
Attribute VB_Name = "frmEstoqueRelatorios"
...
Private Sub cmdSair_Click()
    Unload Me
    Set frmEstoqueRelatorios = Nothing
End Sub
