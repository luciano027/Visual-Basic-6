VERSION 5.00
Begin VB.Form frmCaixaInserir 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Caixa Inserir"
   ClientHeight    =   3645
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   6645
   ...
   Begin Vendas.VistaButton cmdsair 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCaixaInserir.frx":0000
      Pictures        =   1
      UseMaskColor    =   -1  'True
      MaskColor       =   65280
      Enabled         =   -1  'True
   ...
   Begin Vendas.VistaButton cmdGravar 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmCaixaInserir.frx":010A
      Pictures        =   1
      UseMaskColor    =   -1  'True
      MaskColor       =   65280
      Enabled         =   -1  'True
   ...
   Begin VB.Image Image1 
      Height          =   4320
      Left            =   0
      Picture         =   "frmCaixaInserir.frx":0B7C
      Stretch         =   -1  'True
      Top             =   0
      Width           =   6675
   End
End
Attribute VB_Name = "frmCaixaInserir"
