...
Begin VB.Form frmcaixaConsulta 
   ...
   Begin VB.Frame frPagamento 
      ...
      Begin VB.Frame frameFormaPagameto 
         ...
         Begin Vendas.VistaButton btnSairPagamento 
            ...
            PictureOffset   =   0
         End
         Begin Vendas.VistaButton cmdDesconto 
            Height          =   615
            Left            =   3360
            TabIndex        =   77
            Top             =   3120
         ...
         Begin VB.Image Image3 
            Height          =   6180
            Left            =   120
            Picture         =   "frmcaixaConsulta.frx":10CE
            Stretch         =   -1  'True
            Top             =   120
            Width           =   4755
         End
      ...
      Begin Vendas.VistaButton cmdsairPG 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmcaixaConsulta.frx":21CF
         Pictures        =   1
         UseMaskColor    =   -1  'True
         MaskColor       =   65280
         Enabled         =   -1  'True
      ...
      Begin Vendas.VistaButton cmdAvista 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmcaixaConsulta.frx":22D9
         Pictures        =   1
         UseMaskColor    =   -1  'True
         MaskColor       =   65280
         Enabled         =   -1  'True
      ...
      Begin Vendas.VistaButton cmdExtrato 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "frmcaixaConsulta.frx":2D4B
         Pictures        =   1
         UseMaskColor    =   -1  'True
         MaskColor       =   65280
         Enabled         =   -1  'True
   ...
   Begin Vendas.VistaButton cmdSair 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmcaixaConsulta.frx":33AF
      Pictures        =   1
      UseMaskColor    =   -1  'True
      MaskColor       =   65280
      Enabled         =   -1  'True
   ...
   Begin Vendas.VistaButton cmdRelatorios 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmcaixaConsulta.frx":34B9
      Pictures        =   1
      UseMaskColor    =   -1  'True
      MaskColor       =   65280
      Enabled         =   -1  'True
   ...
   Begin Vendas.VistaButton cmdConsultar 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmcaixaConsulta.frx":35CB
      Pictures        =   2
      UseMaskColor    =   -1  'True
      MaskColor       =   65280
      Enabled         =   -1  'True
   ...
   Begin Vendas.VistaButton cmdConsultar2 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmcaixaConsulta.frx":35E7
      Pictures        =   2
      UseMaskColor    =   -1  'True
      MaskColor       =   65280
      Enabled         =   -1  'True
   ...
   Begin Vendas.VistaButton cmdPagamento 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "frmcaixaConsulta.frx":3603
      Pictures        =   1
      UseMaskColor    =   -1  'True
      MaskColor       =   65280
      Enabled         =   -1  'True
   ...
   Begin VB.Image Image2 
      ...
      Height          =   7335
      Left            =   120
      Picture         =   "frmcaixaConsulta.frx":3955
      Stretch         =   -1  'True
      Top             =   360
      Width           =   5400
   End
   Begin VB.Image Image1 
      Height          =   9480
      Left            =   -360
      Picture         =   "frmcaixaConsulta.frx":5F10
      Stretch         =   -1  'True
      Top             =   -1080
      Width           =   16440
   End
...
Private Sub Lista(SQconsulta As String)
    ...
    lblTotalCaixa.Caption = Format((mDinheiro + mPrazo + mCartao + mBoleto), "###,##0.00")
...
Private Sub Visualizar_Pagamento()
    ...
    If txtid_caixa.text <> "" Then
        ...
        If caixa.RecordCount > 0 Then
            ...
            txtDinheiro.text = lblDinheiroC.Caption
            txtCartao.text = lblCartaoC.Caption
            txtBoleto.text = lblBoletoC.Caption
            ListaItens ("")
        End If
    End If
...
Private Sub txtCartao_LostFocus()
    ...
    lblCartaoC.Caption = Format(txtCartao.text, "###,##0.00")
...
Private Sub txtboleto_LostFocus()
    ...
    lblBoletoC.Caption = Format(txtBoleto.text, "###,##0.00")
...
Private Sub verifica_senha()
    ...
    If mTipoAcesso = "A" And mTipo = "E" Then
        VendasCancelar
        mTipo = ""
        Exit Sub
    End If
