VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} rptFichaExtrato 
   ...
   _ExtentX        =   35930
   _ExtentY        =   19606
   SectionData     =   "rptFichaExtrato.dsx":0000
End
Attribute VB_Name = "rptFichaExtrato"
...
Private Sub ActiveReport_Initialize()
    Call ConfiguraIcones(rptFichaExtrato)
End Sub

Private Sub ActiveReport_KeyPress(KeyAscii As Integer)
    If KeyAscii = 27 Then
        Unload rptFichaExtrato
        Set rptFichaExtrato = Nothing
    End If
End Sub
...
Private Sub ActiveReport_ToolbarClick(ByVal Tool As DDActiveReports2.DDTool)
    Select Case Tool.ID
    Case Is = 1000
        Call ExportaRelatorio(MenuPrincipal.cdgRelatorio, rptFichaExtrato)
    Case Is = 23
        Unload rptFichaExtrato
        Set rptFichaExtrato = Nothing
    Case Is = 4015
        Call ExportaRelatorio(MenuPrincipal.cdgRelatorio, rptFichaExtrato)
    Case Is = 22
        Call EnviarPeloEmail(MenuPrincipal.cdgRelatorio, rptFichaExtrato)
    End Select
End Sub
